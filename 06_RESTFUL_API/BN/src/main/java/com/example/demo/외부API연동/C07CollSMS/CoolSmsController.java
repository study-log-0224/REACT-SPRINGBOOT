...
public class CoolSmsController {
    ...
    private String API_KEY = "REDACTED_API_KEY";       // 솔라피 API Key
    private String API_SECRET = "REDACTED_API_SECRET";    // 솔라피 API Secret
    private String FROM = "REDACTED_PHONE";          // 사전 등록된 발신번호 (예: 01012345678)
