...
public class TossPaymentsController {
    ...
    public ResponseEntity<String> confirm(
        ...
        // 멱등키(Idempotency-Key): 같은 주문(orderId)의 승인 요청이 재시도돼도 중복 결제되지 않도록 보장
        // 문서: https://docs.tosspayments.com/reference/using-api/api-keys#멱등키
        header.add("Idempotency-Key", orderId);
